...
st.markdown("""
By hosting this app on a Raspberry Pi 4, I aim to demonstrate the capabilities of edge computing and showcase how even compact devices can handle modern web applications.
